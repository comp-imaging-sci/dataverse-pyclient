...
- Download the full dataset (not reccomended!): `python -u download_client.py --doi doi:10.7910/DVN/CUFVKE`
- Download all files with a given extension (e.g. all `.mat` files): `python -u download_client.py --doi doi:10.7910/DVN/CUFVKE --pattern *.mat`
- Download as specific file (e.g. `read_data.m`): `python -u download_client.py --doi doi:10.7910/DVN/CUFVKE --pattern read_data.m`
